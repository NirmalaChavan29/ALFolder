//  page 60102 NewSalesOrderSubform
...
page 60102 NewSalesOrderSubform
{
        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Variant Code"; Rec."Variant Code")
                {
                    ...
                    //         VariantCodeMandatory := IsVariantMandatory(Rec.Type = Rec.Type::Item, Rec."No.");
                    // end;
                }
    ...
    begin
        ...
        // IsPACEnabled := IsPACEnvironmentEnabled();
    end;
    ...
    var
        ...
        RecVariant: Variant;
    begin
        if IsRecordSaved() then begin
            case Rec.Type of
                Rec.Type::Item:
                    begin
                        RecVariant := GetSavedRecord();
                        Item := RecVariant;
