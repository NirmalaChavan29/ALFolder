// page 60103 NewSalesOrderDocPage
// {
...
//             }
//             //
//             part(Lines; NewSalesOrderSubform)
//             {
//                 ApplicationArea = Basic, Suite;
...
//     procedure ShowPrepmtCrMemoPreview()
//     var
...
page 60103 "NewSalesOrderDocPage"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(SalesLines; NewSalesOrderSubform)
            {
                ApplicationArea = Basic, Suite;
            ...
            group("Shipping and Billing")
            {
                ...
                field("Completely Shipped"; salesheader."Completely Shipped")
                {
                    ApplicationArea = Basic, Suite;
                    Importance = Additional;
                    Visible = false;
...
#pragma warning restore
            ...
            group(History)
            {
                ...
                action(PageInteractionLogEntries)
                {
                    ...
                    trigger OnAction()
                    begin
                        salesheader.ShowInteractionLogEntries();
                    end;
                }
            }
        }
