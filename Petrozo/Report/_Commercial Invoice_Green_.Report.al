report 59014 "Commercial Invoice_Green"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    Caption = 'Commercial Invoice Orchid';
    PreviewMode = PrintLayout;
    RDLCLayout = './CommercialInvoiceVat.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            begin
                ...
                /*BankAccount.Reset();
                if BankAccount.get(bank) then;*/
                BankAccount.Reset();
                BankAccount.SetRange("No.", "Sales Invoice Header"."Bank Account");
            ...
            begin//LP
                ...
                //LP
                if Reportcaption = 1 then CaptionReport := 'Tax Invoice';
