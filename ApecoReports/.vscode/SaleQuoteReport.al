    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(StockUpdate; StockUpdate)
                {
            ...
            begin
                ...
                // if ShiptoCode = true then

                //     //Shiptocodes := "Ship-to Code";





                if PrintCaption = true then
                    Caption1 := 'Performa Invoice'

                else
                    Caption1 := 'Sales Quote';
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(PrintCaption; PrintCaption)
