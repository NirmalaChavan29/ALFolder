report 50102 "Aged Accounts payable - RSPL"
{
    DefaultLayout = RDLC;
    RDLCLayout = './AgedAccountPayableRSPL.rdl';
    ApplicationArea = All;
    Caption = 'Aged Accounts Payable -RSPL1';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(GrandTotalVLE5RemAmtFCYCaptionLbl; GrandTotalVLE5RemAmtFCYCaptionLbl)
            {
            }
            ...
            dataitem(CurrencyLoop; "Integer")
            {
                ...
                dataitem(TempVendortLedgEntryLoop; "Integer")
                {
                    ...
                    column(VLEEndingDateRemAmtFCY; VendorLedgEntryEndingDate."Remaining Amount")
                    {
                        AutoFormatType = 1;
                    }
        ...
        dataitem(CurrencyTotals; "Integer")
        {
            ...
            column(AgedVendLedgEnt7RemAmtLCY7; AgedVendorLedgEntry[6]."Remaining Amount")
            {
                AutoFormatExpression = CurrencyCode;
                AutoFormatType = 1;
            }
    ...
    var
        ...
        GrandTotalVLE5RemAmtLCYCaptionLbl: Label 'Balance LCY';
        GrandTotalVLE5RemAmtFCYCaptionLbl: Label 'Balance FCY';
