report 50103 "Inventory Valuation -Apeco"
{
    DefaultLayout = RDLC;
    RDLCLayout = './InventoryValuation-Apeco.rdl';
    ApplicationArea = All;
    Caption = 'Inventory Valuation - Apeco1';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            begin
                ...
                CalculateItem(Item);
                begin
                    Amt1L := (StartingInvoicedValue) - (DecreaseInvoicedValue) + (IncreaseInvoicedValue);
                    SaleTotal := DecreaseInvoicedQty * "Unit Price";
                end;
